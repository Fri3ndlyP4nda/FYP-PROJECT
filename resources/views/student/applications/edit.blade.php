...
@section('content')
    ...
    {{--
        ...
        Same contract as create.blade.php: every input id and class is left
        alone because the same script drives both, and this is the screen a
        candidate returns to with work already in it.
    --}}
    <div class="deck deck--form">
        <header class="deck-head">
            <div>
                <p class="deck-eyebrow">Draft &nbsp;·&nbsp; {{ strtoupper(substr((string) $application->_id, -6)) }}</p>
                <h1 class="deck-title">Finish your application</h1>
            </div>
            <div class="deck-acts">
        ...
        <p class="form-lede">
            Your answers are saved. You can keep saving as a draft, and nothing reaches the faculty
            until you submit.
        </p>
